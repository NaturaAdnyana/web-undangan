...
<div class="grid md:grid-cols-8">
    ...
    <div class="md:col-span-3 flex justify-center px-8 bg-gray-200 pb-5 pt-1">
        <form class="w-full bg-white shadow-xl rounded px-8 pb-8 mb-5 mt-5 flex flex-col space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="w-full">
                ...
                <input class="shadow border rounded w-full py-2 px-3 text-grey-darker" id="name" type="text" placeholder="Nama Lengkap Anda" name="name">
                @error('name')
